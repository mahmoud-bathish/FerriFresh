          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-center md:text-right">
              <a 
                ...
                className="hover:text-amber-400 transition-colors duration-200 flex items-center justify-center md:justify-end gap-1"
              >
                ...
                <span className="text-amber-400 font-medium text-sm" dir="ltr">+961 70 407 916</span>
